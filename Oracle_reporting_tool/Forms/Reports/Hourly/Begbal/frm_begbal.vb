...
Public Class frm_begbal
    ...
    Private Sub SetupGrid()
        ...
        cmbCol.HeaderText = "Time Mixing"
        cmbCol.Name = "time_mixing"
        cmbCol.FlatStyle = FlatStyle.Flat
        cmbCol.Items.Add("Retarding")
        ...
        cmbRemarks.Items.Add("Produced Donuts")
        cmbRemarks.Items.Add("Received Donuts")
        ...
        Try
            ...
            If Guna2DataGridView1.Columns(e.ColumnIndex).Name = "jpops_qty" Then
                ...
                If Decimal.TryParse(row.Cells("jpops_qty").Value?.ToString(), userInput) Then
                    ...
                    Dim computedValue As Decimal = userInput * 56D * 7D / 35D
    ...
    Private Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        If MsgBox("Are you sure want to save the entry data?", vbQuestion + vbYesNo, "System Message") = vbYes Then
            cls_hourlyPOS.SaveProducedDonut(Guna2DataGridView1)
        End If
    End Sub
End Class